...
% Usage: \setsubtitle{<subtitle>}
	\setsubtitle{Clustering, association mining and anomaly detection}

%% Set the date the report is handed in
% Usage: \setdate{<hand-in date>}
	\setdate{May 7th 2013}
...
\usepackage[final,english,margin]{fixme}
...
\inputtex{introduction}
\inputtex{clustering}
%\inputtex{association_mining}
\inputtex{anomaly_detection}
\inputtex{conclusion}
